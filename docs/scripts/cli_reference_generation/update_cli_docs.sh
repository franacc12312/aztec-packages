...
#   ./scripts/cli_reference_generation/update_cli_docs.sh bb                       # Updates bb CLI, all versions
...
python3 "$SCRIPT_DIR/scan_cli.py" --command "$CLI_COMMAND" --cli-format "$CLI_FORMAT" --output "$TEMP_JSON"
