...
#       CLI_OUTPUT_FILE, CLI_SIDEBAR_POSITION, CLI_TAGS, CLI_DESCRIPTION
#
...
get_cli_config() {
  ...
  CLI_DESCRIPTION=$(echo "$cli_config" | jq -r '.description')
  # Format tags as bracket-enclosed comma-separated list for YAML front-matter
