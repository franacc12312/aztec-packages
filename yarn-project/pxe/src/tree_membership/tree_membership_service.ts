...
export class TreeMembershipService {
   ...
   */
  public async getMembershipWitness(blockHash: Fr, treeId: MerkleTreeId, leafValue: Fr): Promise<Fr[]> {
   ...
   */
  public getPublicDataWitness(blockHash: Fr, leafSlot: Fr): Promise<PublicDataWitness | undefined> {
  ...
  async #tryGetMembershipWitness(blockHash: Fr, treeId: MerkleTreeId, value: Fr): Promise<Fr[] | undefined> {
    switch (treeId) {
