...
describe('DutyAlreadySignedError', () => {
  ...
  it('should work with ATTESTATION duty type', () => {
    const error = new DutyAlreadySignedError(SlotNumber(200), DutyType.ATTESTATION, 'node-2');
  ...
  it('should work with ATTESTATIONS_AND_SIGNERS duty type', () => {
    const error = new DutyAlreadySignedError(SlotNumber(300), DutyType.ATTESTATIONS_AND_SIGNERS, 'node-3');
...
describe('SlashingProtectionError', () => {
  ...
  it('should include truncated signing roots in message', () => {
    const error = new SlashingProtectionError(SlotNumber(100), DutyType.BLOCK_PROPOSAL, existingRoot, attemptedRoot);
  ...
  it('should work with ATTESTATION duty type', () => {
    const error = new SlashingProtectionError(SlotNumber(200), DutyType.ATTESTATION, existingRoot, attemptedRoot);
