...
const RouterContractArtifact: ContractArtifact = {
  name: 'Router',
  functions: [
    {
      ...{
...
export class RouterContract extends ContractBase {
  private constructor(wallet: Wallet) {
    super(ProtocolContractAddress.Router, RouterContractArtifact, wallet);
  }

  public static at(wallet: Wallet): RouterContract {
    return new RouterContract(wallet);
  }
